...
public class EventTests extends AbstractTest {
    ...
    public void listTest() throws IOException {
        ...
        List<? extends Event> events = osv3().telemetry().events(false).list(null);
    ...
    public void getTest() throws IOException {
        ...
        Event event = osv3().telemetry().events(false).get("adeda2eb-31e5-4908-a7dd-7a154abed468");
    ...
    public void listEventTypesTest() throws IOException {
        ...
        List<String> eventTypes = osv3().telemetry().events(false).listEventTypes();
    ...
    public void listTraitDescriptionsTest() throws IOException {
        ...
        List<? extends TraitDescription> traitDescriptions
                = osv3().telemetry().events(false).listTraitDescriptions("image.upload");
    ...
    public void listTraitsTest() throws IOException {
        ...
        List<? extends Trait> traits = osv3().telemetry().events(false).listTraits("image.upload", "service");
